...
public class HspitalManagement {
    ...
    public static List<Integer> romRecList = new ArrayList();
    public static String[] addDel = new String[20];
    ...
    public static void printListOne() {
        ...
        System.out.println("\tBy ghazi hamada");
        System.out.println("\t---------------------");
    ...
    public static void responsible() {
        ...
        while (true) {
            ...
            System.out.println("\t\t6. Add a receptionist");
            System.out.println("\t\t7. Delete a receptionist");
            ...
            switch (key) {
                ...
                case 6:
                    ...
                    if (!d) {
                        ...
                        System.out.println("There is Same receptionist with this Data!");
                    }
                    break;
                case 7:
                ...
                case 14:
                    ...
                    System.out.println("\t---------------------\n");
                    for (int i = 0; i < addDel.length; i++) {
                        Boolean x = romRecList.contains(i);
                        if (x) {
                            System.out.println(addDel[i]);
                        }
                    }
                    break;
                case 15:
                    ...
                    d = romRecList.contains(num);
                    if (d) {
                        romRecList.remove(num);
                    } else {
